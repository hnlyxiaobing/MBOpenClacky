...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "sessions.modelFallback": "The selected model is no longer available; the session was created with the default model.",
      ...
      "channels.test.running":    "Testing…",
      "channels.test.ok":         "✓ Connectivity OK ({{ms}} ms)",
      "channels.test.failed":     "✗ Connectivity failed: {{msg}}",
    ...
    zh: {
      ...
      "sessions.modelFallback": "所选模型已不可用，已改用默认模型创建会话。",
      ...
      "channels.test.running":    "正在测试…",
      "channels.test.ok":         "✓ 连通性正常（{{ms}} ms）",
      "channels.test.failed":     "✗ 连通性失败：{{msg}}",
