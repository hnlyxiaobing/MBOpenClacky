...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.models.btn.saveAnyway":    "Save anyway",
      "settings.models.btn.saving":        "Saving…",
      "settings.models.btn.saved":         "Saved ✓",
      "settings.models.btn.testing":       "Testing…",
      "settings.models.btn.test":          "Test",      "settings.models.link.topUp":        "Top up / Manage account",
      ...
      "settings.models.testWarnSaveAnyway": " (you can still click Save anyway)",
      "settings.models.saveFailed":        "Save failed",      "settings.models.setDefaultFailed":  "Failed to set default model",
    ...
    zh: {
      ...
      "settings.models.btn.saveAnyway":    "仍然保存",
      "settings.models.btn.saving":        "保存中…",
      "settings.models.btn.saved":         "已保存 ✓",
      "settings.models.btn.testing":       "测试中…",
      "settings.models.btn.test":          "测试",      "settings.models.link.topUp":        "充值 / 账户管理",
      ...
      "settings.models.testWarnSaveAnyway": "（仍可点击强行保存）",
      "settings.models.saveFailed":        "保存失败",      "settings.models.setDefaultFailed":  "设置默认模型失败",
