...
| 子 Spec | 文件名 | 状态 | 工作量 |
|---------|--------|------|--------|
| 成本计算接线 | `2026-07-17_01_cost-tracker-wiring.md` | 已就绪 | 0.5 天 |
| 渠道占位修复 | `2026-07-17_02_channel-placeholder-fixes.md` | 已就绪 | 3-4 天 |
| SQLite 决策 | `2026-07-17_03_sqlite-persistence-decision.md` | 已决策（方案A） | 0.5 天 |
| C 头文件提取 | `2026-07-17_04_c-header-files.md` | 已就绪（可选） | 0.5 天 |
| 第三方许可 | `2026-07-17_05_third-party-licenses.md` | 已就绪 | 0.5 天 |
