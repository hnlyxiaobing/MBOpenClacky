...
> **关联历史 spec**: 边界——005 闸门背后的压缩语义归 `2026-08-18_17_p5-compression-trigger-semantics.md`（BUG-0042 修复后本 spec 激活 005）；013 闸门归 p5-retry-backoff-circuit-breaker（BUG-0039）；014 的 BUG-0040 断言归 B2 决策 2（伪 JSON 修复）；12 剧本的差分断言维护归既有 test/e2e 纪律（AGENTS.md 第 4 节诚实标注）  
