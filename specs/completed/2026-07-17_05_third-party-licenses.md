...
| KaTeX | 0.16.11 | ❌ 缺失 | ✅ 已标注 |
| QRCode | 1.5.4 | ❌ 缺失 | ✅ 已标注 |
| CodeMirror | 6.0.1 | ❌ 缺失 | ✅ 已标注 |
...
- 从 GitHub 下载 KaTeX 的 LICENSE 文件（MIT）
- 从 GitHub 下载 QRCode 的 LICENSE 文件（MIT）
- 从 GitHub 下载 CodeMirror 的 LICENSE 文件（MIT）
- 保存到 `web/js/lib/` 目录
...
| 2026-07-17 | 对抗性审查：确认 KaTeX/QRCode/CodeMirror 状态 | 已验证 `web/js/lib/katex/`、`qrcode/`、`codemirror/` 目录存在，但同样缺少 LICENSE 文件，需一并补齐 |
