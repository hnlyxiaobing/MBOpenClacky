...
// AES-GCM/CSPRNG must come from audited platform crypto (OpenSSL / Windows
// CNG); no audited pure-MoonBit alternative exists (docs/ffi-c-code-report.md
// "FFI 必要性总结": 密码学原语 — 成立; §9 lib/brand). Security retention.
#include <stdint.h>
#include <string.h>
